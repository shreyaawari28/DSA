...
This repository contains my **Data Structures and Algorithms (DSA)** practice using **Java**, including **LeetCode problems** and standard interview questions.  
The focus is on building strong problem-solving skills through **consistent, logic-driven practice**.
